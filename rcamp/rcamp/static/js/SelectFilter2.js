...
window.SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_static_prefix) {
        ...
        selector_div.className = 'row selector'

        // <div class="selector-available">
        var selector_available = quickElement('div', selector_div);
        selector_available.className = 'col-md-4 col-md-offset-1 selector-available';
        // var title_available = quickElement('h4', selector_available, interpolate(gettext('Available %s') + ' ', [field_name]));
        ...
        selector_chooser.className = 'col-md-1 selector-chooser';
        var add_link = quickElement('a', quickElement('li', selector_chooser), gettext(''), 'title', gettext('Choose'), 'href', 'javascript: (function(){ SelectBox.move("' + field_id + '_from","' + field_id + '_to"); SelectFilter.refresh_icons("' + field_id + '");})()', 'id', field_id + '_add_link');
        add_link.className = 'selector-add';
        var remove_link = quickElement('a', quickElement('li', selector_chooser), gettext(''), 'title', gettext('Remove'), 'href', 'javascript: (function(){ SelectBox.move("' + field_id + '_to","' + field_id + '_from"); SelectFilter.refresh_icons("' + field_id + '");})()', 'id', field_id + '_remove_link');
        ...
        selector_chosen.className = 'col-md-4 selector-chosen';
        // var title_chosen = quickElement('h4', selector_chosen, interpolate(gettext('Chosen %s') + ' ', [field_name]));
