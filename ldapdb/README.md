...
_django-ldapdb_ requires Django version >= 1.6.x.
...
something like this to your _models.py_:
    ...
    class LdapGroup(ldapdb.models.Model):
        ...
        name = CharField(db_column='cn', max_length=200)
...
_Important note_ : you _must_ declare an attribute to be used as the rdn_key. This
attribute will play a special role, as it will be used to build the
...
_The Distinguished Name of any LDAP model will always act as its primary key_.
